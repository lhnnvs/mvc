...
<body class="d-flex flex-column bg-dark vh-100">
    <div class="container d-flex flex-column flex-fill text-white fs-3 px-5 py-4" style="max-width: 768px; background-image: url('../assets/images/bg.jpg'); background-size: cover;">
        ...
        <div class="d-flex flex-fill align-items-center justify-content-center text-center">
            <form method="POST" action="<?= ROOT ?>/kiosk/qr?report_id=<?= $_GET['report_id'] ?>" class="d-flex flex-column align-items-center">
                ...
                <button type="submit" class="btn btn-light fw-bold fs-3 w-75" id="confirmButton">Confirm</button>
            </form>
        </div>
    </div>
